...
you can already view transaction in explorer</span>
    ...
    return (
        <Dialog open={openModal} onOpenChange={(_open) => setOpenModal(_open)}>
            ...
            Assets will be locked. After the transaction is successfully completed, the assets will be automatically sent to the destination wallet address you provided. Verify all details before confirming.
          </span>
                </div>
            </DialogContent>
        </Dialog>
